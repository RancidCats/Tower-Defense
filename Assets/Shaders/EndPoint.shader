	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color14 = IsGammaSpace() ? float4(0,0.6941915,1,0) : float4(0,0.4397613,1,0);
				float time21 = _TimeParameters.x;
				float2 voronoiSmoothId21 = 0;
				float2 coords21 = IN.ase_texcoord7.xy * -1.34;
				float2 id21 = 0;
				float2 uv21 = 0;
				...
				float fresnelNode11 = ( voroi21 + 2.13 * pow( 1.0 - fresnelNdotV11, 2.05 ) );
				float4 lerpResult9 = lerp( float4( 0,0,0,0 ) , color14 , fresnelNode11);
				float4 lerpResult19 = lerp( float4( 0,0,0,0 ) , tex2DNode8 , lerpResult9);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float time21 = _TimeParameters.x;
				float2 voronoiSmoothId21 = 0;
				float2 coords21 = IN.ase_texcoord2.xy * -1.34;
				float2 id21 = 0;
				float2 uv21 = 0;
				float voroi21 = voronoi21( coords21, time21, id21, uv21, 0, voronoiSmoothId21 );
...
/*ASEBEGIN
Version=18935
0;73;889;650;1278.615;917.5286;2.873173;False;False
Node;AmplifyShaderEditor.SimpleTimeNode;23;-790.5448,-385.8088;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-774.5448,-275.8088;Inherit;False;Constant;_Float3;Float 3;1;0;Create;True;0;0;0;False;0;False;-1.34;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-599.2162,-61.56201;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;2.13;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;21;-549.0887,-388.8073;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RangedFloatNode;17;-457.1938,19.64191;Inherit;False;Constant;_Float2;Float 2;1;0;Create;True;0;0;0;False;0;False;2.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;-187.8841,30.91916;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0.6941915,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;11;-322.0213,-258.7936;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;122.6883,30.85705;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;d9b94f23aef7a5f4083cae7faeb4b295;d9b94f23aef7a5f4083cae7faeb4b295;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;9;51.24335,-244.8935;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;19;385.6512,-255.3033;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3E86A7FED6CF33D4FEDF1B1CD5BF190FADF3F532