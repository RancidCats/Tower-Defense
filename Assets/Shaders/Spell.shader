	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float time8 = _TimeParameters.x;
				float2 voronoiSmoothId8 = 0;
				float2 coords8 = IN.ase_texcoord7.xy * 6.1;
				float2 id8 = 0;
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0, voronoiSmoothId8 );
				float fresnelNdotV9 = dot( WorldNormal, WorldViewDirection );
				float fresnelNode9 = ( voroi8 + 1.77 * pow( 1.0 - fresnelNdotV9, 1.68 ) );
				float4 color13 = IsGammaSpace() ? float4(1,0.2229757,0,0) : float4(1,0.04072025,0,0);
				float4 temp_output_16_0 = ( fresnelNode9 * color13 * 2.49 );
				...
				float Occlusion = 1;
				float Alpha = temp_output_16_0.r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float time8 = _TimeParameters.x;
				float2 voronoiSmoothId8 = 0;
				float2 coords8 = IN.ase_texcoord3.xy * 6.1;
				float2 id8 = 0;
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0, voronoiSmoothId8 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0, voronoiSmoothId8 );
				float fresnelNdotV9 = dot( IN.worldNormal, ase_worldViewDir );
				float fresnelNode9 = ( voroi8 + 1.77 * pow( 1.0 - fresnelNdotV9, 1.68 ) );
				float4 color13 = IsGammaSpace() ? float4(1,0.2229757,0,0) : float4(1,0.04072025,0,0);
				float4 temp_output_16_0 = ( fresnelNode9 * color13 * 2.49 );
...
/*ASEBEGIN
Version=18935
0;73;889;650;284.2372;329.8233;1;False;False
Node;AmplifyShaderEditor.SimpleTimeNode;11;-764.2573,-136.0556;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-725.431,15.82199;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;6.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-380.8138,8.335406;Inherit;False;Constant;_Float2;Float 2;0;0;Create;True;0;0;0;False;0;False;1.77;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-345.5142,131.6354;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;1.68;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;8;-537.7353,-144.2596;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.ColorNode;13;-109.5755,114.3096;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,0.2229757,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;258.2758,-274.2132;Inherit;False;Constant;_Float3;Float 3;0;0;Create;True;0;0;0;False;0;False;2.49;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;9;-210.1708,-144.1475;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;189.6059,-142.0334;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3B38A8934610F33F3FF93EA42B0C9004757010D1